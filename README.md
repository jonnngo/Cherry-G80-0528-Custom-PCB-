This is a work in progress, I aim to fix/improve upon this first iteration very soon. This project is supposed to be a custom PCB replacement for the Cherry G80-0528 powered by a much more modern microcontroller (STM32F411), QMK firmware, using usb-c. Made using KiCad.
